...
DROP TABLE IF EXISTS "bento_model_rel";
DROP TABLE IF EXISTS "bento";
DROP TYPE IF EXISTS "bento_image_build_status";
DROP TYPE IF EXISTS "bento_upload_status";
DROP TABLE IF EXISTS "bento_repository";
DROP TABLE IF EXISTS "model";
DROP TYPE IF EXISTS "model_upload_status";
DROP TYPE IF EXISTS "model_image_build_status";
DROP TABLE IF EXISTS "model_repository";
